...
import { getCategories, getRandomMeals } from '../services/api';
...
const HomePage = () => {
  ...
  return (
    ...
    <div className="container mx-auto p-6">
      <Banner/>
      <div>
      <h1 className="text-2xl font-bold mt-12 text-center text-[#008000]">Latest Meals</h1>
        <MealList meals={randomMeals} />
      </div>
      
      <div className="mb-8">
      <h1 className="text-2xl font-bold mt-12 text-center text-[#008000]">Explore Meals</h1>
